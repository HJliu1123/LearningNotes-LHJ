...
-(id)initWithOrigin:(CGPoint)origin andDiameter:(CGFloat)diameter andDelegate:(UIView *)View themeColor:(UIColor *)themeColor {
...
-(void)setUpSomeDatas{
    ...
    CGFloat degree = (180/(menuCount))*(2*M_PI/180);
    ...
    for (int i = 0; i < menuCount; i++) {
        ...
        //设置每个item的图片
        CGFloat imageWidth = (item.frame.size.width / 3 * 2) *sin(M_PI_4) * 2;
