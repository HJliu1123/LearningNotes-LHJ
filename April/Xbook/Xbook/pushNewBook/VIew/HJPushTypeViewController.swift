//
//  HJPushTypeViewController.swift
//  Xbook
//
...
typealias HJPushTypeViewControllerBlock = (type : String, detailType : String)->Void

class HJPushTypeViewController: UIViewController ,IGLDropDownMenuDelegate{
    ...
    var humanitesArray1 : Array<NSDictionary> = []
    var humanitesArray2 : Array<NSDictionary> = []
    ...
    var callBack : HJPushTypeViewControllerBlock?
    ...
    func initSegment() {
        ...
        self.segmentController1?.addTarget(self, action: #selector(HJPushTypeViewController.segmentControllerAction(_:)), forControlEvents: .ValueChanged)
        self.segmentController2?.addTarget(self, action: #selector(HJPushTypeViewController.segmentControllerAction(_:)), forControlEvents: .ValueChanged)
    ...
    func segmentControllerAction(segment : AKSegmentedControl) {
        ...
        switch (index) {
            case 0:
                ...
                break
            case 1:
                self.createDropMenu(self.humanitesArray1, array2: self.humanitesArray2)
                break
            case 2:
